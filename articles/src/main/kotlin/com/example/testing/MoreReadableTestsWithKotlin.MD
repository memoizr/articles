...
It's not exactly a pleasure to read a screen full of this stuff is it? The `giver-when-then` keywords take up precious space on the screen. I really don't want to read a screen full of this stuff, because after a while it sort of starts looking a bit like:
...
But wait what's that? Oh it's the good old `BlahblahBlahblahBlahblahIsIt530YetBlahblahBlahblah()` effect again!

Now, it's Kotlin we're using, so let's use the `` thingy Kotlin offers, I say. Feel free to use them in your test methods, or even class names, and feel free to write your test name in a as readable and as descriptive way as you can. This is what I'd rather see:
...
But that's only my fallible opinion anyway, what do *YOU* think?
